...
{ 
    ...
    var taskassignsubId=$('#taskassignsubId').val();
    ...
    else
    {
    	if(taskassignsubId>0 )
    	{
    		...
    		$.ajax({
        url:base_path+"TaskcreationEdit/updatetask",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        ...
        success: function(data) {
          console.log(data);
           ...
           $('#btn_save').html('Save');
            ...
            window.location.href = base_path+"Taskdetails";
          }
      });
    	}
      //   else
      ...
      // var formData = new FormData(form[0]);
    	...
    	// 	$.ajax({
      //   url:base_path+"TaskcreationEdit/inserttask",
      //   type: "POST",
