...
class TaskCreation extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('TaskCreation/modifyTaskCreation_view',$data);
	...
	{
		$data['Gtype']=$this->TaskCreation_model->getalltaskType2();
		$data['Ptype']=$this->TaskCreation_model->getalltaskType3();
		$data['Ttype']=$this->TaskCreation_model->getalltaskType4();
		$data['Wtype']=$this->TaskCreation_model->getalltaskType5();
		$data['Rtype']=$this->TaskCreation_model->getalltaskType6();
		$data['Utype']=$this->TaskCreation_model->getalltaskType7();
		$data['Btype']=$this->TaskCreation_model->getalltaskType8();
		$data['Stype']=$this->TaskCreation_model->getalltaskType9();
		$data['showprojectname']=$this->TaskCreation_model->getProjectName();
		$data['tasktype']=$this->TaskCreation_model->getTasktype();
		$data['userByLogin']=$this->TaskCreation_model->getUserByLogin();
		...
		$this->load->view('common/header_view',$data);
		$this->load->view('TaskCreation/TaskCreation_view',$data);
		$this->load->view('common/footer_view');
	}
	...
	// 	 } 
	  ...
	  {
		  $data['dataa']=$this->TaskCreation_model->getallSongByid($this->uri->segment(3));
		...
		//  $data['country']=$this->TaskCreation_model->getCountry();
