<?php
  class TaskCreation_model extends CI_Model {
    ...
    public function __construct()
     ...
     {      
             ...
             $this->db->select('task_master.*,project_master.projectName,group_master.*');
             $this->db->join('project_master','task_master.fktaskTypenameId2 = project_master.projectId','left'); 
             ...
             $this->db->order_by("task_master.taskId", "desc"); 
              $query = $this->db->get();
              return $query->result();
