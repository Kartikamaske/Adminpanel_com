            ...
            <div class="main-content" style="margin-top:-50px">
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                            <h3><img src="https://img.icons8.com/fluency/512/music-transcript.png" style="width: 25px">&ensp;Lyrics</h3>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/LyricsCreate.js"></script>
