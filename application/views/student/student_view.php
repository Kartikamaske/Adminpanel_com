                                ...
                                <form role="form" id="Form" action="" method="post">
                                    <div class="row">
                                        <div class="col-md-4 form-group mb-3">
                                            <label for="firstName1">Student Full Name</label>
                                            <input class="form-control" id="studentname" type="text" placeholder="Enter your first name" name="studentname" value="" />
                                        </div>
                                        ...
                                        <div class="col-md-1 form-group mb-3">
                                            ...
                                            <input class="form-control" id="age" type="number" placeholder="Enter Age" name="age" value="" />
                                        </div>
                                 ...
                                 <div class="col-md-2 form-group mb-3">
                                        ...
                                        <div class="col-md-2 form-group mb-3">
                                            <label for="picker1">Last Qualification</label>
                                        ...
                                        <div class="col-md-2 form-group mb-3">
                                            <label for="picker1">Course Applied for</label>
                                            <select class="form-control" name="department" id="course">
                                                <option value="1">English</option>
                                                <option value="2">Marathi</option>
                                                <option value="3">Hindi</option>
                                            </select>
                                        ...
                                        <div class="col-md-2 form-group mb-3">
                                            ...
                                            <input class="form-control" id="motherName" type="text"  placeholder="Enter mother Name" name="motherName" value="" />
                                        </div>

                                        <div class="col-md-2 form-group mb-3">
                                            <label for="phone">Father name.</label>
                                            <input class="form-control" id="fatherName" type="text"  placeholder="Enter father Name" name="fatherName" value="" />
                                        </div>

                                        <div class="col-md-2 form-group mb-3">
                                            <label for="phone">Student photo</label>
