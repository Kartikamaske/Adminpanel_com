        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1><img src="https://cdn-icons-png.flaticon.com/512/9417/9417564.png"style="width: 25px">&ensp;Features</h1>
                    <!-- <ul>
                                    ...
                                    <div class="row">
                                       ...
                                       <!-- <div class="col-md-2 form-group mb-3">
                                        ...
                                        <button class="btn btn-primary" type="button" name="btn_save" id="btn_save"><i class="nav-icon fa-regular fa-circle-check"></i>&nbsp;Submit</button>
                                            <a href="<?=base_url() ?>Features"> <button class="btn btn-warning text-white" type="button" name="list" id="list"><i class="fa-sharp fa-solid fa-pen-to-square"></i>&nbsp;List</button></a>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/FeaturesCreate.js"></script>
