                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="form-row"> 
                                <div class="col-12 col-sm-12 col-md-3 col-lg-2">
                                    ...
                                    <input type="datetime-local" name="leave_start_date" id="leave_start_date"  class="form-control" value="<?php if(!empty($dataa[0]->leave_start_date)){echo $dataa[0]->leave_start_date;}?>">
                                ...
                                <div class="col-12 col-sm-12 col-md-3 col-lg-2 md-5">
                                    ...
                                    <input type="datetime-local" name="leave_end_date" id="leave_end_date" class="form-control" value="<?php if(!empty($dataa[0]->leave_end_date)){echo $dataa[0]->leave_end_date;}?>">
                                </div>
                            </div><br>
                            ...
                            <div class="form-row"> 
                                ...
                                <label for="">Leave Reason</label>&ensp;
