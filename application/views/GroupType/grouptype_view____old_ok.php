    ...
    <div class="main-content">
        ...
        <div class="separator-breadcrumb border-top"></div>
          <div class="form-row mt-4">
                      ...
                      <div class="form-row">
                        <div class="col-12 col-sm-12 col-lg-12 col-md-12">
                          <div class="mb-3" id="usertypeBox">
                            ...
                            <?php
                                  foreach ($AddedGroup as $key => $TTtype) {
                                    $selected="";
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="select2 form-control form-control-sm" multiple id="selectuserid" name="selectuserid[]" style="width: 100%;"> 
                                                   ...
                                                   <?php
                                                    ...
                                                    echo '<option value="'.$Stype->registrationId.'"'.$selected.' >'
                                                    .$Stype->fname.'</option>';
                                ...
                                <div class="row">
                                  ...
                                  <div class=" col-md-6">
                                    <label for="Tagname">Task Type</label>
                                        <select class="select2 form-control form-control-sm" multiple  id="tasktypeid" name="tasktypeid[]" style="width: 100%;"> 
                                                  ...
                                                  echo '<option value="'.$STtype->tasktypeid.'"'.$selected.' >'
                                                  .$STtype->tasktypename .'</option>';
                                  ...
                                  <div class="col-md-6">
                                    <!-- <a href="#" class="btn btn-success" style="margin-top:30px;" id="search">
                                    Search</a> -->
           ...
           <!-- for update the table onclick event -->
                                    <?php 
                            ...
                            if (!empty($dataa)) {
                              ...
                              foreach($itemsa as $rw=>$value){
                                ...
                                echo "<td><input type='checkbox'check checked".$a." id='chkbox".$i. "' value='".$value->fkcheck. "' onclick='mycheck(".$i. ")'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' class='checktask'  name='checktask[]' id='inputchk".$i. "' value='".$value->fkcheck. "'></td>";
                            ...
                            <div class="col-md-12 text-right">
                                            ...
                                            <i class="fa-solid fa-book"></i> Submit </a> </button>
                                            

                                            <button class="btn btn-primary text-white" type="button" name="cancle" id="cancle">
                                            <a href="<?=base_url() ?>Grouptype" class="text-white text-decoration-none">
