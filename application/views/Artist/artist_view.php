            ...
            <div class="main-content" style="margin-top:-50px">
                ...
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                            <h3><img src="https://img.icons8.com/fluency/512/listening-to-music-on-headphones.png" style="width: 25px">&ensp;Artist</h3>
                                <form role="form" id="Form" action="" method="post">
                                    <div class="form-row">
                                        <div class="col-md-4 form-group mb-3">
                                            <label for="firstName1">Name:</label>
                                            <input class="form-control" id="artist_name" type="text" placeholder="" name="artist_name" value="" />
                                        </div>
                                   ...
                                   <label class="radio radio-primary">
                                    <input type="radio" name="gender" value="3"><span class="pr-1">Other</span><span class="checkmark"></span>
                                        ...
                                        <div class="col-md-12 text-right">
                                            ...
                                            <a href="<?=base_url() ?>Artist"> <button class="btn btn-warning text-white" type="button" name="list" id="list"><i class="fa-sharp fa-solid fa-pen-to-square"></i>&nbsp;List</button></a>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/ArtistCreate.js"></script>
