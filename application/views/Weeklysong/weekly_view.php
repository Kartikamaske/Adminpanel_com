        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1><img src="https://cdn-icons-png.flaticon.com/512/1486/1486474.png" style="width:25px">&ensp;Weekly Top 15 Songs</h1>
                    <!-- <ul>
                                ...
                                <form role="form" id="Form" action="" method="post">
                                    <div class="row">
                                        <div class="col-md-4 form-group mb-3">
                                            <label for="firstName1">Weekly Top 15 Song Name:</label>
                                            <!-- <input class="form-control" id="songtname" type="text" placeholder="" name="" value="" /> -->
                                            <select class="form-control" id="weeklytopsongname" name="weeklytopsongname">
                                       ...
                                       <!-- <div class="col-md-2 form-group mb-3">
                                        ...
                                        <button class="btn btn-primary" type="button" name="btn_save" id="btn_save"><i class="nav-icon fa-regular fa-circle-check"></i>&nbsp;Submit</button>
                                            <a href="<?=base_url() ?>Weeklysong"> <button class="btn btn-warning text-white" type="button" name="list" id="list"><i class="fa-sharp fa-solid fa-pen-to-square"></i>&nbsp;List</button></a>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/WeeklytopCreate.js"></script>
