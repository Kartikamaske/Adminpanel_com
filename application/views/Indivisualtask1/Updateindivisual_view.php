                        ...
                        <div class="form-row">
                                  <div class="col-12 col-sm-2 col-md-4">
                                      <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control overflow-scroll" id="taskname" placeholder="" autofocus="focus" readonly name="taskname" value="<?php if(!empty($dataa[0]->taskname)){echo $dataa[0]->taskname;}?>">
