                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-2 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="taskname" id="taskname" cols="50" autofocus="focus"><?php if(!empty($dataa[0]->taskname)){echo $dataa[0]->taskname;}?></textarea>  
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                  ...
                                  <div class="col-12 col-sm-2 col-md-4">
                                      <div class="mb-3">
                                          ...
                                          <input type="date" class="form-control" id="enddate" readonly  name="enddate" value="<?php if(!empty($dataa[0]->enddate)){echo $dataa[0]->enddate;}?>">
                         ...
                         <div class="form-row">
                                  ...
                                  <div class="col-12 col-sm-2 col-md-4">
                                      <div class="mb-3">
                                          ...
                                          <input type="datetime" class="form-control" id="endtime" readonly name="endtime" value="<?php if(!empty($dataa[0]->endtime)){echo $dataa[0]->endtime;}?>">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-2 col-md-4">
                                ...
                                <div class="col-md-12 text-right">
                                    ...
                                    <!-- <a href="<?=base_url() ?>Indivisualtask" class="text-white text-decoration-none">  -->
                                        <button class="btn btn-primary" type="button" name="btn_save" id="btn_save"> <i class="fa-regular fa-circle-check"></i>Submit
                                        </button>
                                    <!-- </a> -->
