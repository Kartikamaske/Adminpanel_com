            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        rid <input type="text" class="form-control" id="registrationId" name="registrationId" value="<?php if(!empty($getfkuser[0]->registrationId)){echo $getfkuser[0]->registrationId;}?>"><br>
                            ...
                            <table class="display table table-striped table-bordered" id="example" style="width:100%">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        // echo  '<td class=""><a href="'.base_url().'Updateindivisualtask/update/'.$value->IndivisualtaskId.'">
                                        // <i class="fa-solid fa-square-pen flag" style="font-size: 19px;"></i></a> 
                                        // </td>';
